...
.controller('CardsCtrl', function ($scope, $http, $ionicLoading, $ionicSideMenuDelegate, TDCardDelegate, $firebase, $firebaseArray, Auth) {
    ...
    var ref = new Firebase("https://YOUR-FIREBASE.firebaseio.com");
     ...
     var recipeRef = new Firebase("https://YOUR-FIREBASE.firebaseio.com/" + user);
    ...
    var url= "http://food2fork.com/api/search?key=API-KEY&q=shredded%20chicken" + "?callback=JSON_CALLBACK";
//$http.get(url)
...
$http.get("http://food2fork.com/api/search?key=API-KEY&q="+firstSearch/*)'https://cors-test.appspot.com/test'*//*'https://randomuser.me/api/?results=30')*/).success(function (data) {
    console.log(data);
  ...
  $scope.newCards = function(){
      ...
      $http.get("http://food2fork.com/api/search?key=API-KEY&q="+newSearch)
    ...
    //$scope.addCard();
      console.log($scope.cards[index]);
        var card = $scope.cards[index];
          var favouriteCards = new Firebase("https://YOUR-FIREBASE.firebaseio.com/" + user + "/cards")
